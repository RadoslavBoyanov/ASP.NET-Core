...
{
    public partial class CreateDataSetsAndSeedDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganiserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Navigation property for user"),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Event create date"),
                    ...
                    TypeId = table.Column<int>(type: "int", nullable: false, comment: "Navigation property for Type")
                },
                constraints: table =>
                {
