    ...
    public partial class AddTablesAndSeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Ad id")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    OwnerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Navigation property for owner "),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Ad image url"),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Created date for ad"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BuyerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Navigation property for Buyer"),
                    AdId = table.Column<int>(type: "int", nullable: false, comment: "Navigation property for Ad")
                },
                constraints: table =>
                {
